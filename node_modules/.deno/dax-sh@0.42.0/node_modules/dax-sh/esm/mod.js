...
import { Deno as Deno2 } from "@deno/shim-deno";
...
// npm/esm/deps/jsr.io/@std/fmt/1.0.2/colors.js
...
// npm/esm/deps/jsr.io/@david/which/0.4.1/mod.js
var RealEnvironment = class {
  env(key) {
    return Deno2.env.get(key);
  }
  stat(path) {
    return Deno2.stat(path);
  }
  statSync(path) {
    return Deno2.statSync(path);
  }
  get os() {
...
function getSystemInfo(command, environment) {
  const isWindows3 = environment.os === "windows";
  const envValueSeparator = isWindows3 ? ";" : ":";
  ...
  return {
    ...
    isNameMatch: isWindows3 ? (a, b) => a.toLowerCase() === b.toLowerCase() : (a, b) => a === b
  };
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/_os.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/_common/assert_path.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/_common/basename.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/_common/strip_trailing_separators.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/_common/constants.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/posix/_util.js
function isPosixPathSeparator(code2) {
  return code2 === CHAR_FORWARD_SLASH;
}

// npm/esm/deps/jsr.io/@std/path/1.0.4/_common/from_file_url.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/posix/from_file_url.js
function fromFileUrl(url) {
  url = assertArg(url);
  return decodeURIComponent(url.pathname.replace(/%(?![0-9A-Fa-f]{2})/g, "%25"));
}

// npm/esm/deps/jsr.io/@std/path/1.0.4/posix/basename.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/_util.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/from_file_url.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/basename.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/basename.js
function basename3(path, suffix = "") {
  return isWindows ? basename2(path, suffix) : basename(path, suffix);
}

// npm/esm/deps/jsr.io/@std/path/1.0.4/_common/dirname.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/posix/dirname.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/dirname.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/dirname.js
function dirname3(path) {
  return isWindows ? dirname2(path) : dirname(path);
}

// npm/esm/deps/jsr.io/@std/path/1.0.4/posix/extname.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/extname.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/extname.js
function extname3(path) {
  return isWindows ? extname2(path) : extname(path);
}

// npm/esm/deps/jsr.io/@std/path/1.0.4/from_file_url.js
function fromFileUrl3(url) {
  return isWindows ? fromFileUrl2(url) : fromFileUrl(url);
}

// npm/esm/deps/jsr.io/@std/path/1.0.4/posix/is_absolute.js
function isAbsolute(path) {
  assertPath(path);
  return path.length > 0 && isPosixPathSeparator(path.charCodeAt(0));
}

// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/is_absolute.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/is_absolute.js
function isAbsolute3(path) {
  return isWindows ? isAbsolute2(path) : isAbsolute(path);
}

// npm/esm/deps/jsr.io/@std/path/1.0.4/_common/normalize.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/_common/normalize_string.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/posix/normalize.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/posix/join.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/normalize.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/join.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/_common/relative.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/posix/relative.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/resolve.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/relative.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/relative.js
function relative3(from, to) {
  return isWindows ? relative2(from, to) : relative(from, to);
}

// npm/esm/deps/jsr.io/@std/path/1.0.4/resolve.js
function resolve3(...pathSegments) {
  return isWindows ? resolve2(...pathSegments) : resolve(...pathSegments);
}

// npm/esm/deps/jsr.io/@std/path/1.0.4/_common/to_file_url.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/posix/to_file_url.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/windows/to_file_url.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/to_file_url.js
function toFileUrl3(path) {
  return isWindows ? toFileUrl2(path) : toFileUrl(path);
}

// npm/esm/deps/jsr.io/@std/fs/1.0.3/_to_path_string.js
function toPathString(pathUrl) {
  return pathUrl instanceof URL ? fromFileUrl3(pathUrl) : pathUrl;
}

// npm/esm/deps/jsr.io/@std/fs/1.0.3/empty_dir.js
async function emptyDir(dir) {
  try {
    const items = await Array.fromAsync(Deno2.readDir(dir));
    await Promise.all(items.map((item) => {
      if (item && item.name) {
        const filepath = join3(toPathString(dir), item.name);
        return Deno2.remove(filepath, { recursive: true });
      }
    }));
  } catch (err) {
...
function emptyDirSync(dir) {
  try {
    const items = [...Deno2.readDirSync(dir)];
    while (items.length) {
...
// npm/esm/deps/jsr.io/@std/fs/1.0.3/_get_file_info_type.js
function getFileInfoType(fileInfo) {
  return fileInfo.isFile ? "file" : fileInfo.isDirectory ? "dir" : fileInfo.isSymlink ? "symlink" : void 0;
}

// npm/esm/deps/jsr.io/@std/fs/1.0.3/ensure_dir.js
async function ensureDir(dir) {
  try {
    const fileInfo = await Deno2.stat(dir);
...
function ensureDirSync(dir) {
  try {
    const fileInfo = Deno2.statSync(dir);
    throwIfNotDirectory(fileInfo);
    return;
  } catch (err) {
    if (!(err instanceof Deno2.errors.NotFound)) {
...
// npm/esm/deps/jsr.io/@std/fs/1.0.3/ensure_file.js
async function ensureFile(filePath) {
  try {
    const stat = await Deno2.lstat(filePath);
    if (!stat.isFile) {
...
function ensureFileSync(filePath) {
  try {
    const stat = Deno2.lstatSync(filePath);
    if (!stat.isFile) {
      throw new Error(`Failed to ensure file exists: expected 'file', got '${getFileInfoType(stat)}'`);
    }
  } catch (err) {
...
// npm/esm/deps/jsr.io/@std/path/1.0.4/constants.js
var SEPARATOR = isWindows ? "\\" : "/";

// npm/esm/deps/jsr.io/@std/fs/1.0.3/_is_subdir.js
...
// npm/esm/deps/jsr.io/@std/fs/1.0.3/copy.js
var isWindows2 = Deno2.build.os === "windows";
...
async function ensureValidCopy(src, dest, options) {
  ...
  if (!options.overwrite) {
    throw new Deno2.errors.AlreadyExists(`'${dest}' already exists.`);
  }
  return destStat;
}
...
async function copyFile(src, dest, options) {
  ...
  await Deno2.copyFile(src, dest);
  if (options.preserveTimestamps) {
    const statInfo = await Deno2.stat(src);
    assertIsDate(statInfo.atime, "statInfo.atime");
    assertIsDate(statInfo.mtime, "statInfo.mtime");
    await Deno2.utime(dest, statInfo.atime, statInfo.mtime);
  }
}
function copyFileSync(src, dest, options) {
  ensureValidCopySync(src, dest, options);
  Deno2.copyFileSync(src, dest);
  if (options.preserveTimestamps) {
    const statInfo = Deno2.statSync(src);
    assertIsDate(statInfo.atime, "statInfo.atime");
    assertIsDate(statInfo.mtime, "statInfo.mtime");
    Deno2.utimeSync(dest, statInfo.atime, statInfo.mtime);
  }
}
async function copySymLink(src, dest, options) {
  await ensureValidCopy(src, dest, options);
  const originSrcFilePath = await Deno2.readLink(src);
  const type = getFileInfoType(await Deno2.lstat(src));
  if (isWindows2) {
    await Deno2.symlink(originSrcFilePath, dest, {
  ...
  if (options.preserveTimestamps) {
    const statInfo = await Deno2.lstat(src);
    assertIsDate(statInfo.atime, "statInfo.atime");
    assertIsDate(statInfo.mtime, "statInfo.mtime");
    await Deno2.utime(dest, statInfo.atime, statInfo.mtime);
  }
...
function copySymlinkSync(src, dest, options) {
  ensureValidCopySync(src, dest, options);
  const originSrcFilePath = Deno2.readLinkSync(src);
  const type = getFileInfoType(Deno2.lstatSync(src));
  if (isWindows2) {
    Deno2.symlinkSync(originSrcFilePath, dest, {
      type: type === "dir" ? "dir" : "file"
    });
  } else {
    Deno2.symlinkSync(originSrcFilePath, dest);
  ...
  if (options.preserveTimestamps) {
    const statInfo = Deno2.lstatSync(src);
    assertIsDate(statInfo.atime, "statInfo.atime");
    assertIsDate(statInfo.mtime, "statInfo.mtime");
    Deno2.utimeSync(dest, statInfo.atime, statInfo.mtime);
  }
...
async function copyDir(src, dest, options) {
  ...
  if (options.preserveTimestamps) {
    const srcStatInfo = await Deno2.stat(src);
    assertIsDate(srcStatInfo.atime, "statInfo.atime");
    assertIsDate(srcStatInfo.mtime, "statInfo.mtime");
    await Deno2.utime(dest, srcStatInfo.atime, srcStatInfo.mtime);
  }
  src = toPathString(src);
  dest = toPathString(dest);
  const promises = [];
  for await (const entry of Deno2.readDir(src)) {
...
function copyDirSync(src, dest, options) {
  ...
  if (options.preserveTimestamps) {
    const srcStatInfo = Deno2.statSync(src);
    assertIsDate(srcStatInfo.atime, "statInfo.atime");
    assertIsDate(srcStatInfo.mtime, "statInfo.mtime");
    Deno2.utimeSync(dest, srcStatInfo.atime, srcStatInfo.mtime);
  }
  src = toPathString(src);
  dest = toPathString(dest);
  for (const entry of Deno2.readDirSync(src)) {
    const srcPath = join3(src, entry.name);
    const destPath = join3(dest, basename3(srcPath));
    if (entry.isSymlink) {
...
async function copy(src, dest, options = {}) {
  ...
  const srcStat = await Deno2.lstat(src);
...
function copySync(src, dest, options = {}) {
  ...
  const srcStat = Deno2.lstatSync(src);
  if (srcStat.isDirectory && isSubdir(src, dest)) {
    throw new Error(`Cannot copy '${src}' to a subdirectory of itself: '${dest}'`);
  }
  if (srcStat.isSymlink) {
...
// npm/esm/deps/jsr.io/@david/path/0.2.0/mod.js
...
Provide a URL, string, or another Path.`);
  ...
  *#rcomponents() {
  ...
  realPath() {
    return Deno2.realPath(this.#path).then((path) => new _Path(path));
  }
  /** Synchronously resolves to the absolute normalized path, with symbolic links resolved. */
  realPathSync() {
    return new _Path(Deno2.realPathSync(this.#path));
  }
  /** Creates a directory at this path.
   * @remarks By default, this is recursive.
   */
  async mkdir(options) {
    await Deno2.mkdir(this.#path, {
      recursive: true,
      ...options
    });
    return this;
  ...
  async linkTo(targetPath) {
    ...
    await Deno2.link(targetPathRef.toString(), this.resolve().toString());
  }
  /**
  ...
  linkToSync(targetPath) {
    const targetPathRef = ensurePath(targetPath).resolve();
    Deno2.linkSync(targetPathRef.toString(), this.resolve().toString());
  }
  /** Reads the entries in the directory. */
  async *readDir() {
    const dir = this.resolve();
    for await (const entry of Deno2.readDir(dir.#path)) {
      yield {
        ...entry,
  ...
  *readDirSync() {
    const dir = this.resolve();
    for (const entry of Deno2.readDirSync(dir.#path)) {
      yield {
        ...entry,
        path: dir.join(entry.name)
      };
  ...
  *readDirFilePathsSync() {
  ...
  readBytes(options) {
    return Deno2.readFile(this.#path, options);
  }
  /** Synchronously reads the bytes from the file. */
  readBytesSync() {
    return Deno2.readFileSync(this.#path);
  }
  ...
  readText(options) {
    return Deno2.readTextFile(this.#path, options);
  }
  /** Synchronously reads the text from the file. */
  readTextSync() {
    return Deno2.readTextFileSync(this.#path);
  }
  ...
  /** Opens a file. */
  open(options) {
    return Deno2.open(this.#path, options).then((file) => createFsFileWrapper(file));
  }
  /** Opens a file synchronously. */
  openSync(options) {
    return createFsFileWrapper(Deno2.openSync(this.#path, options));
  }
  /** Removes the file or directory from the file system. */
  async remove(options) {
    await Deno2.remove(this.#path, options);
    return this;
  }
  /** Removes the file or directory from the file system synchronously. */
  removeSync(options) {
    Deno2.removeSync(this.#path, options);
    return this;
  }
  ...
  copyFile(destinationPath) {
    const pathRef = ensurePath(destinationPath);
    return Deno2.copyFile(this.#path, pathRef.toString()).then(() => pathRef);
  }
  /**
  ...
  copyFileSync(destinationPath) {
    const pathRef = ensurePath(destinationPath);
    Deno2.copyFileSync(this.#path, pathRef.toString());
    return pathRef;
  }
  /**
  ...
  rename(newPath) {
    ...
    return Deno2.rename(this.#path, pathRef.toString()).then(() => pathRef);
  }
  /**
  ...
  renameSync(newPath) {
    const pathRef = ensurePath(newPath);
    Deno2.renameSync(this.#path, pathRef.toString());
    return pathRef;
  }
  /**
  ...
  async pipeTo(dest, options) {
    const file = await Deno2.open(this.#path, { read: true });
    try {
...
var FsFileWrapper = class extends Deno2.FsFile {
  /** Writes the provided text to this file. */
  writeText(text) {
...
async function createSymlink(opts) {
  let kind = opts.type;
  if (kind == null && Deno2.build.os === "windows") {
    ...
    if (info?.isDirectory) {
      ...
      throw new Deno2.errors.NotFound(`The target path '${opts.targetPath}' did not exist or path kind could not be determined. When the path doesn't exist, you need to specify a symlink type on Windows.`);
    }
  }
  await Deno2.symlink(opts.text, opts.fromPath.toString(), kind == null ? void 0 : {
    type: kind
  });
}
function createSymlinkSync(opts) {
  ...
  Deno2.symlinkSync(opts.text, opts.fromPath.toString(), kind == null ? void 0 : {
    type: kind
  });
}
...
// npm/esm/deps/jsr.io/@std/assert/0.221.0/assertion_error.js
...
// npm/esm/deps/jsr.io/@std/assert/0.221.0/assert.js
...
// npm/esm/deps/jsr.io/@std/bytes/0.221.0/copy.js
...
// npm/esm/deps/jsr.io/@std/io/0.221.0/buffer.js
...
// npm/esm/deps/jsr.io/@std/io/0.221.0/write_all.js
...
// npm/esm/deps/jsr.io/@std/io/0.221.0/reader_from_stream_reader.js
...
// npm/esm/deps/jsr.io/@std/streams/0.221.0/reader_from_stream_reader.js
function readerFromStreamReader2(streamReader) {
  return readerFromStreamReader(streamReader);
}

// npm/esm/deps/jsr.io/@std/streams/0.221.0/writer_from_stream_writer.js
...
// npm/esm/deps/jsr.io/@std/io/0.221.0/buf_reader.js
...
// npm/esm/src/lib/rs_lib.generated.js
var wasm;
...
// npm/esm/src/lib/mod.js
var wasmInstance = instantiate();

// npm/esm/src/console/logger.js
...
async function* readKeys() {
  ...
  while (true) {
    ...
    const byteCount = await Deno2.stdin.read(buf);
    if (byteCount == null) {
      break;
    }
    if (byteCount === 3) {
...
function hideCursor() {
  Deno2.stderr.writeSync(encoder.encode("\x1B[?25l"));
}
function showCursor() {
  Deno2.stderr.writeSync(encoder.encode("\x1B[?25h"));
}
var isOutputTty = safeConsoleSize() != null && isTerminal(Deno2.stderr);
function isTerminal(pipe) {
  if (typeof pipe.isTerminal === "function") {
    return pipe.isTerminal();
  } else if (pipe.rid != null && typeof Deno2.isatty === "function") {
    return Deno2.isatty(pipe.rid);
  } else {
...
function createSelection(options) {
  if (!isOutputTty || !isTerminal(Deno2.stdin)) {
...
function ensureSingleSelection(action) {
  ...
  const currentPromise = (async () => {
    ...
    hideCursor();
    try {
      Deno2.stdin.setRaw(true);
      try {
        return await action();
      } finally {
        Deno2.stdin.setRaw(false);
      }
    } finally {
      showCursor();
    }
...
var staticText = {
  set(items, size) {
    ...
    const { columns, rows } = size ?? Deno2.consoleSize();
    const newText = wasmInstance.static_text_render_text(items, columns, rows);
    if (newText != null) {
      Deno2.stderr.writeSync(encoder.encode(newText));
    }
  },
...
// npm/esm/src/console/confirm.js
...
// npm/esm/src/console/multiSelect.js
...
// npm/esm/src/console/progress/format.js
...
// npm/esm/src/console/progress/interval.js
var intervalMs = 60;
var progressBars = [];
...
// npm/esm/src/console/progress/mod.js
...
async function getExecutableShebangFromPath(path) {
  try {
    const file = await Deno2.open(path, { read: true });
    try {
...
async function executeCat(context) {
  ...
  for (const path of flags.paths) {
    if (path === "-") {
      ...
      let file;
      try {
        file = await Deno2.open(resolvePath(context.cwd, path), { read: true });
        while (!context.signal.aborted) {
...
async function doCopyOperation(flags, from, to) {
  ...
  if (fromInfo?.isDirectory) {
    ...
    await Deno2.copyFile(from.path, to.path);
  }
}
async function copyDirRecursively(from, to) {
  await Deno2.mkdir(to, { recursive: true });
  const readDir = Deno2.readDir(from);
  for await (const entry of readDir) {
    ...
    if (entry.isDirectory) {
      ...
      await Deno2.copyFile(newFrom, newTo);
    }
  }
}
...
async function executeMove(cwd, args) {
  ...
  for (const { from, to } of flags.operations) {
    await Deno2.rename(from.path, to.path);
  }
}
...
// npm/esm/src/commands/export.js
...
async function executeMkdir(cwd, args) {
  ...
  for (const specifiedPath of flags.paths) {
    ...
    if (flags.parents) {
      await Deno2.mkdir(path, { recursive: true });
    } else {
      await Deno2.mkdir(path);
    }
  }
}
...
// npm/esm/src/commands/printenv.js
function printEnvCommand(context) {
  let args;
  if (Deno2.build.os === "windows") {
...
function executePrintEnv(env, args) {
  const isWindows3 = Deno2.build.os === "windows";
  if (args.length === 0) {
...
async function executeRemove(cwd, args) {
  ...
  await Promise.all(flags.paths.map((specifiedPath) => {
    ...
    return Deno2.remove(path, { recursive: flags.recursive }).catch((err) => {
      if (flags.force && err instanceof Deno2.errors.NotFound) {
...
// npm/esm/deps/jsr.io/@std/fs/1.0.3/exists.js
async function exists(path, options) {
  try {
    const stat = await Deno2.stat(path);
    ...
    if (error instanceof Deno2.errors.NotFound) {
      return false;
    }
    if (error instanceof Deno2.errors.PermissionDenied) {
      if ((await Deno2.permissions.query({ name: "read", path })).state === "granted") {
...
function existsSync(path, options) {
  try {
    const stat = Deno2.statSync(path);
    if (options && (options.isReadable || options.isDirectory || options.isFile)) {
      if (options.isDirectory && options.isFile) {
        throw new TypeError("ExistsOptions.options.isDirectory and ExistsOptions.options.isFile must not be true together");
      }
    ...
    if (error instanceof Deno2.errors.PermissionDenied) {
      if (Deno2.permissions.querySync({ name: "read", path }).state === "granted") {
        return !options?.isReadable;
      }
    }
    throw error;
...
function fileIsReadable(stat) {
  if (stat.mode === null) {
    return true;
  } else if (Deno2.uid() === stat.uid) {
    return (stat.mode & 256) === 256;
  } else if (Deno2.gid() === stat.gid) {
    return (stat.mode & 32) === 32;
  }
  return (stat.mode & 4) === 4;
}

// npm/esm/src/commands/test.js
...
async function executetouch(args) {
  ...
  for (const path of flags.paths) {
    const f = await Deno2.create(path);
    f.close();
  }
}
...
// npm/esm/src/runtimes/process.node.js
...
var spawnCommand = (path, options) => {
  ...
  return {
    ...
    stderr() {
      return Readable.toWeb(child.stderr);
    }
  };
};

// npm/esm/src/shell.js
...
var RealEnv = class {
  ...
  setEnvVar(key, value) {
    if (value == null) {
      Deno2.env.delete(key);
    } else {
      Deno2.env.set(key, value);
    }
  }
  getEnvVar(key) {
    return Deno2.env.get(key);
  ...
  if (ioFile.kind === "fd") {
    ...
    switch (redirect.op.kind) {
      case "input": {
        ...
        try {
          const file = await Deno2.open(outputPath, {
            read: true
          });
          return {
            kind: "input",
...
async function executeCommandAtPath(commandPath, commandArgs, context) {
  ...
  const stdinPromise = writeStdin(context.stdin, p, completeSignal).catch(async (err) => {
    ...
    try {
      ...
      if (!(err2 instanceof Deno2.errors.PermissionDenied || err2 instanceof Deno2.errors.NotFound)) {
        throw err2;
      }
    }
  });
...
function pipeCommandPipeReaderToWriterSync(reader, writer, signal) {
  switch (reader) {
    case "inherit":
      return pipeReadableToWriterSync(Deno2.stdin.readable, writer, signal);
    case "null":
      return Promise.resolve();
    default: {
...
async function resolveCommand(unresolvedCommand, context) {
  if (unresolvedCommand.name.includes("/") || Deno2.build.os === "windows" && unresolvedCommand.name.includes("\\")) {
...
function parseAndSpawnCommand(state) {
  ...
  const stdout = new ShellPipeWriter(state.stdout.kind, stdoutBuffer === "null" ? new NullPipeWriter() : stdoutBuffer === "inherit" ? Deno2.stdout : stdoutBuffer);
  const stderr = new ShellPipeWriter(state.stderr.kind, stderrBuffer === "null" ? new NullPipeWriter() : stderrBuffer === "inherit" ? Deno2.stderr : stderrBuffer);
  ...
  return new CommandChild(async (resolve4, reject) => {
    try {
      ...
      let code2 = await spawn2(list, {
        stdin: stdin instanceof ReadableStream2 ? readerFromStreamReader2(stdin.getReader()) : stdin,
        stdout,
        stderr,
        env: buildEnv(state.env, state.clearEnv),
        commands: state.commands,
        cwd: state.cwd ?? Deno2.cwd(),
        exportEnv: state.exportEnv,
      ...
      if (code2 !== 0) {
        ...
        if (!noThrow) {
          if (stdin instanceof ReadableStream2) {
            if (!stdin.locked) {
              stdin.cancel();
            }
          }
      ...
      const result = new CommandResult(code2, finalizeCommandResultBuffer(stdoutBuffer), finalizeCommandResultBuffer(stderrBuffer), combinedBuffer instanceof Buffer ? combinedBuffer : void 0);
  ...
  function getBuffers() {
    ...
    const stdoutBuffer2 = getOutputBuffer(Deno2.stdout, state.stdout);
    const stderrBuffer2 = getOutputBuffer(Deno2.stderr, state.stderr);
...
var CommandResult = class {
  ...
  code;
  /** @internal */
  constructor(code2, stdout, stderr, combined) {
    this.code = code2;
    this.#stdout = stdout;
    this.#stderr = stderr;
...
function buildEnv(env, clearEnv) {
  const result = clearEnv ? {} : Deno2.env.toObject();
        ...
        if (inputOrOutputRedirect === "<") {
          ...
          if (expr instanceof Path) {
            ...
            handleWritableStream(() => {
              ...
              if (!(stream instanceof WritableStream2)) {
...
var helperObject = {
  ...
  which(commandName) {
    if (commandName.toUpperCase() === "DENO") {
      return Promise.resolve(Deno2.execPath());
    } else {
  ...
  function getLogText(data) {
    const combinedText = data.map((d) => {
      ...
      if (typeofD !== "object" && typeofD !== "undefined") {
        ...
        return Deno2.inspect(d, { colors: true });
      }
    }).join(" ");
    if (state.indentLevel.value === 0) {
      return combinedText;
