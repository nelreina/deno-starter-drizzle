...
export { type DirEntry, FsFileWrapper, Path, type SymlinkOptions } from "./deps/jsr.io/@david/path/0.2.0/mod.js";
export type { Delay, DelayIterator } from "./src/common.js";
export { TimeoutError } from "./src/common.js";
/** @deprecated Import `Path` instead. */
declare const PathRef: typeof Path;
export { PathRef };
...
export type { CdChange, ContinueExecuteResult, EnvChange, ExecuteResult, ExitExecuteResult, SetEnvVarChange, SetShellVarChange, UnsetVarChange, } from "./src/result.js";
/**
...
/** Type of `$` instances. */
export type $Type<TExtras extends ExtrasObject = {}> = $Template & (string extends keyof TExtras ? $BuiltInProperties<TExtras> : Omit<$BuiltInProperties<TExtras>, keyof TExtras>) & TExtras;
 ...
 * ```
 */
export declare function build$<TExtras extends ExtrasObject = {}>(options?: Create$Options<TExtras>): $Type<TExtras>;
/**
...
export default $;
/** @internal */
declare function createPath(path: string | URL | Path): Path;
